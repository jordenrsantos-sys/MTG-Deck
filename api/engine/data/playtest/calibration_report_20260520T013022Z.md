# MPA Calibration Report — 2026-05-20T01:30:22Z
...
|---|---|---|---|---|---|---|---|
| B5_vs_B2 | 10 | 0.900 | 0.85-0.95 | ✓ | 0.000 | 0.100 | 5/4 |
...
- **actual:** deck_a winrate = 0.900 over 10 games
- **in band:** True; drift amount: 0.000
- **draws:** 1 (0.100 draw rate)
- **seat wins:** seat0=5, seat1=4
- **elapsed:** 3.4s
...
| 4 | True | A_wins | 36 | thoracle_consult_combo |
| 5 | False | A_wins | 25 | thoracle_consult_combo |
...
- **expected:** 0.55-0.70 (medium)
- **actual:** deck_a winrate = 0.800 over 10 games
- **in band:** False; drift amount: 0.100
- **draws:** 0 (0.000 draw rate)
- **seat wins:** seat0=5, seat1=5
- **elapsed:** 3.7s
...
| 3 | False | A_wins | 23 | thoracle_consult_combo |
| 4 | True | A_wins | 22 | thoracle_consult_combo |
| 5 | False | A_wins | 39 | life_to_zero |
| 6 | True | B_wins | 49 | life_to_zero |
| 7 | False | B_wins | 32 | life_to_zero |
| 8 | True | A_wins | 36 | thoracle_consult_combo |
...
- Finish-rate healthy (draw rate 15.0% < 20%); calibration signal is usable.
