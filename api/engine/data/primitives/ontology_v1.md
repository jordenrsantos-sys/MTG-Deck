# Pillar C — Primitive Ontology v1 (iter 5 expansion)

Status: SHIPPED in mega-task v4 Phase 3. Extends v0's 64-tag / 6-
dimension spec with a 7th dimension `rules_modifiers` (17 tags)
capturing mandatory/optional triggers, targeting restrictions,
combat-vs-any damage, and the other rules-level distinctions v0
...
**Total tag count: 81 across 7 dimensions (64 v0 + 17 rules_modifiers).**
