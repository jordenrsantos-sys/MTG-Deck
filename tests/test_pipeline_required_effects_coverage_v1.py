...
from api.engine.layers.required_effects_coverage_v1 import REQUIRED_EFFECTS_COVERAGE_V1_VERSION
...
class PipelineRequiredEffectsCoverageV1Tests(unittest.TestCase):
    ...
    def test_pipeline_reports_required_effects_payload_and_panel_gate(self) -> None:
        ...
        required_payload = result.get("required_effects_coverage_v1")
        self.assertIsInstance(required_payload, dict)
        self.assertEqual(required_payload.get("version"), REQUIRED_EFFECTS_COVERAGE_V1_VERSION)

        status = required_payload.get("status")
        ...
        self.assertIs(available_panels.get("has_required_effects_coverage_v1"), True)

        pipeline_versions = result.get("pipeline_versions") if isinstance(result.get("pipeline_versions"), dict) else {}
        self.assertEqual(pipeline_versions.get("required_effects_version"), "required_effects_v1")
