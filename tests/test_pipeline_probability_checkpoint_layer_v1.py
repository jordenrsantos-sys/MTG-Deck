...
from api.engine.layers.probability_checkpoint_layer_v1 import PROBABILITY_CHECKPOINT_LAYER_V1_VERSION
...
class PipelineProbabilityCheckpointLayerV1Tests(unittest.TestCase):
    ...
    def test_pipeline_reports_probability_checkpoint_payload_and_panel_gate(self) -> None:
        ...
        checkpoint_payload = result.get("probability_checkpoint_layer_v1")
        self.assertIsInstance(checkpoint_payload, dict)
        self.assertEqual(checkpoint_payload.get("version"), PROBABILITY_CHECKPOINT_LAYER_V1_VERSION)
        ...
        self.assertIs(available_panels.get("has_probability_checkpoint_layer_v1"), True)

        pipeline_versions = result.get("pipeline_versions") if isinstance(result.get("pipeline_versions"), dict) else {}
        self.assertEqual(
            pipeline_versions.get("probability_checkpoint_version"),
