...
from api.engine.layers.mulligan_model_v1 import MULLIGAN_MODEL_V1_VERSION
...
class PipelineMulliganModelV1Tests(unittest.TestCase):
    ...
    def test_pipeline_reports_mulligan_model_payload_and_panel_gate(self) -> None:
        ...
        mulligan_payload = result.get("mulligan_model_v1")
        self.assertIsInstance(mulligan_payload, dict)
        self.assertEqual(mulligan_payload.get("version"), MULLIGAN_MODEL_V1_VERSION)

        status = mulligan_payload.get("status")
        ...
        self.assertIs(available_panels.get("has_mulligan_model_v1"), True)

        pipeline_versions = result.get("pipeline_versions") if isinstance(result.get("pipeline_versions"), dict) else {}
        self.assertEqual(pipeline_versions.get("mulligan_model_version"), MULLIGAN_MODEL_V1_VERSION)
