# MPA Calibration Report — 2026-05-20T01:57:23Z
...
|---|---|---|---|---|---|---|---|
| B5_vs_B2 | 10 | 0.200 | 0.85-0.95 | ✗ | 0.650 | 0.000 | 7/3 |
| B4_vs_B2 | 10 | 0.500 | 0.70-0.85 | ✗ | 0.200 | 0.000 | 4/6 |
| B4_vs_B3 | 10 | 0.400 | 0.55-0.70 | ✗ | 0.150 | 0.000 | 7/3 |
| B3_vs_B2 | 10 | 0.600 | 0.55-0.70 | ✓ | 0.000 | 0.000 | 3/7 |
| B5_vs_B4 | 10 | 0.100 | 0.55-0.70 | ✗ | 0.450 | 0.000 | 4/6 |
| mirror_B3_pillow_fort | 10 | 0.200 | 0.45-0.55 | ✗ | 0.250 | 0.100 | 6/3 |

## Headline aggregates

- **Matchups outside expected band (drift count):** `5` of `6`
- **Overall draw rate (all matchups):** `0.0167` (1 draws / 60 games)
- **Anti-bias mirror check:** seat 0 won `6`, seat 1 won `3` (seat 0 share = 0.667 of decisive games; draws=1)
...
- **actual:** deck_a winrate = 0.200 over 10 games
- **in band:** False; drift amount: 0.650
- **draws:** 0 (0.000 draw rate)
- **seat wins:** seat0=7, seat1=3
- **elapsed:** 3.2s

| # | swap | outcome | turns | loss_reason |
|---|---|---|---|---|
| 1 | False | B_wins | 22 | life_to_zero |
| 2 | True | B_wins | 15 | life_to_zero |
| 3 | False | B_wins | 16 | life_to_zero |
| 4 | True | B_wins | 23 | life_to_zero |
| 5 | False | A_wins | 13 | thoracle_consult_combo |
| 6 | True | B_wins | 11 | life_to_zero |
| 7 | False | A_wins | 15 | thoracle_consult_combo |
| 8 | True | B_wins | 17 | life_to_zero |
| 9 | False | B_wins | 20 | life_to_zero |
| 10 | True | B_wins | 13 | life_to_zero |
...
- **actual:** deck_a winrate = 0.500 over 10 games
- **in band:** False; drift amount: 0.200
- **draws:** 0 (0.000 draw rate)
- **seat wins:** seat0=4, seat1=6
- **elapsed:** 3.5s

| # | swap | outcome | turns | loss_reason |
|---|---|---|---|---|
| 1 | False | B_wins | 18 | life_to_zero |
| 2 | True | B_wins | 19 | life_to_zero |
| 3 | False | A_wins | 23 | life_to_zero |
| 4 | True | B_wins | 13 | life_to_zero |
| 5 | False | B_wins | 16 | life_to_zero |
| 6 | True | A_wins | 18 | life_to_zero |
| 7 | False | A_wins | 15 | life_to_zero |
| 8 | True | A_wins | 22 | life_to_zero |
| 9 | False | B_wins | 24 | life_to_zero |
| 10 | True | A_wins | 14 | life_to_zero |
...
| # | swap | outcome | turns | loss_reason |
|---|---|---|---|---|
| 1 | False | A_wins | 41 | life_to_zero |
| 2 | True | A_wins | 28 | life_to_zero |
| 3 | False | A_wins | 35 | life_to_zero |
| 4 | True | B_wins | 35 | life_to_zero |
| 5 | False | A_wins | 19 | life_to_zero |
| 6 | True | B_wins | 17 | life_to_zero |
| 7 | False | B_wins | 24 | life_to_zero |
| 8 | True | B_wins | 17 | life_to_zero |
| 9 | False | B_wins | 24 | life_to_zero |
| 10 | True | B_wins | 25 | life_to_zero |
...
- **draws:** 0 (0.000 draw rate)
- **seat wins:** seat0=3, seat1=7
- **elapsed:** 3.5s

| # | swap | outcome | turns | loss_reason |
|---|---|---|---|---|
| 1 | False | B_wins | 14 | life_to_zero |
| 2 | True | A_wins | 26 | life_to_zero |
| 3 | False | B_wins | 22 | life_to_zero |
| 4 | True | A_wins | 14 | life_to_zero |
| 5 | False | A_wins | 13 | life_to_zero |
| 6 | True | A_wins | 14 | life_to_zero |
| 7 | False | A_wins | 41 | life_to_zero |
| 8 | True | B_wins | 29 | life_to_zero |
| 9 | False | B_wins | 18 | life_to_zero |
| 10 | True | A_wins | 12 | life_to_zero |
...
| 2 | True | B_wins | 19 | life_to_zero |
| 3 | False | B_wins | 20 | life_to_zero |
| 4 | True | B_wins | 11 | life_to_zero |
| 5 | False | B_wins | 22 | life_to_zero |
| 6 | True | B_wins | 21 | life_to_zero |
| 7 | False | B_wins | 14 | life_to_zero |
| 8 | True | B_wins | 17 | life_to_zero |
| 9 | False | B_wins | 24 | life_to_zero |
...
- **seat wins:** seat0=6, seat1=3
- **elapsed:** 3.4s

| # | swap | outcome | turns | loss_reason |
|---|---|---|---|---|
| 1 | False | A_wins | 19 | life_to_zero |
| 2 | True | B_wins | 35 | life_to_zero |
| 3 | False | A_wins | 15 | life_to_zero |
| 4 | True | draw | 50 | turn_cap_reached |
| 5 | False | B_wins | 24 | life_to_zero |
| 6 | True | B_wins | 23 | life_to_zero |
| 7 | False | B_wins | 28 | life_to_zero |
| 8 | True | B_wins | 25 | life_to_zero |
| 9 | False | B_wins | 24 | life_to_zero |
| 10 | True | B_wins | 17 | life_to_zero |

## Recommendations

- Finish-rate healthy (draw rate 1.7% < 20%); calibration signal is usable.
