...
from api.engine.layers.stress_model_definition_v1 import STRESS_MODEL_DEFINITION_V1_VERSION
...
class PipelineStressModelDefinitionV1Tests(unittest.TestCase):
    ...
    def test_pipeline_reports_stress_model_definition_payload_and_panel_gate(self) -> None:
        ...
        stress_payload = result.get("stress_model_definition_v1")
        self.assertIsInstance(stress_payload, dict)
        self.assertEqual(stress_payload.get("version"), STRESS_MODEL_DEFINITION_V1_VERSION)
        ...
        self.assertIs(available_panels.get("has_stress_model_definition_v1"), True)

        pipeline_versions = result.get("pipeline_versions") if isinstance(result.get("pipeline_versions"), dict) else {}
        self.assertEqual(pipeline_versions.get("stress_model_version"), STRESS_MODEL_DEFINITION_V1_VERSION)
